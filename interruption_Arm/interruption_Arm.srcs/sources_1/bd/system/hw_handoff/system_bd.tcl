...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set rdy_signals [ create_bd_port -dir I -from 3 -to 0 rdy_signals ]
...
CONFIG.PCW_USE_M_AXI_GP0 {0} \
  ...
  connect_bd_net -net pb_rdy_0_rdy_out [get_bd_pins pb_rdy_0/rdy_out] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins pb_rdy_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0]
  connect_bd_net -net rdy_signals_1 [get_bd_ports rdy_signals] [get_bd_pins pb_rdy_0/rdy_signals]
