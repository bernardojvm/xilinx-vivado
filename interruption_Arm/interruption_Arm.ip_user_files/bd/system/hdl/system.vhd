...
architecture STRUCTURE of system is
  ...
  component system_pb_rdy_0_0 is
  port (
    rdy_signals : in STD_LOGIC_VECTOR ( 3 downto 0 );
    clk : in STD_LOGIC;
    rdy_out : out STD_LOGIC
  );
  end component system_pb_rdy_0_0;
  ...
  signal rdy_signals_1 : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal NLW_processing_system7_0_FCLK_RESET0_N_UNCONNECTED : STD_LOGIC;
begin
  rdy_signals_1(3 downto 0) <= rdy_signals(3 downto 0);
pb_rdy_0: component system_pb_rdy_0_0
     port map (
      clk => processing_system7_0_FCLK_CLK0,
      rdy_out => pb_rdy_0_rdy_out,
      rdy_signals(3 downto 0) => rdy_signals_1(3 downto 0)
    );
