...
HD_PWD='C:/xup/fpga_flow/2016_2_zynq_labs/interruption_Arm/interruption_Arm.runs/system_pb_rdy_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pb_rdy_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pb_rdy_0_0.tcl
