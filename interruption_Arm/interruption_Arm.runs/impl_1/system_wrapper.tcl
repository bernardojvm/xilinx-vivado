...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/xup/fpga_flow/2016_2_zynq_labs/interruption_Arm/interruption_Arm.cache/wt [current_project]
  set_property parent.project_path C:/xup/fpga_flow/2016_2_zynq_labs/interruption_Arm/interruption_Arm.xpr [current_project]
  set_property ip_repo_paths {
  c:/xup/fpga_flow/2016_2_zynq_labs/ip_repo
  C:/xup/fpga_flow/2016_2_zynq_labs/pB_rdy
} [current_project]
  set_property ip_output_repo C:/xup/fpga_flow/2016_2_zynq_labs/interruption_Arm/interruption_Arm.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet C:/xup/fpga_flow/2016_2_zynq_labs/interruption_Arm/interruption_Arm.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/xup/fpga_flow/2016_2_zynq_labs/interruption_Arm/interruption_Arm.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files C:/xup/fpga_flow/2016_2_zynq_labs/interruption_Arm/interruption_Arm.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc C:/xup/fpga_flow/2016_2_zynq_labs/interruption_Arm/interruption_Arm.srcs/constrs_1/new/zybo.xdc
  set_param project.isImplRun true
