...
set rc [catch {
  ...
  set_property webtalk.parent_dir C:/xup/fpga_flow/2016_2_zynq_labs/wBRAM/wBRAM.cache/wt [current_project]
  set_property parent.project_path C:/xup/fpga_flow/2016_2_zynq_labs/wBRAM/wBRAM.xpr [current_project]
  set_property ip_output_repo C:/xup/fpga_flow/2016_2_zynq_labs/wBRAM/wBRAM.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet C:/xup/fpga_flow/2016_2_zynq_labs/wBRAM/wBRAM.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files C:/xup/fpga_flow/2016_2_zynq_labs/wBRAM/wBRAM.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files C:/xup/fpga_flow/2016_2_zynq_labs/wBRAM/wBRAM.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc C:/xup/fpga_flow/2016_2_zynq_labs/wBRAM/wBRAM.srcs/constrs_1/imports/lab1/lab1_zybo.xdc
  set_param project.isImplRun true
