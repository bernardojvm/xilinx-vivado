...
HD_PWD='C:/xup/fpga_flow/2016_2_zynq_labs/lab4_ipi/lab4_ipi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wave_gen_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wave_gen_top.tcl
