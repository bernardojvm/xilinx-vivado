...
HD_PWD='C:/xup/fpga_flow/2016_2_zynq_labs/lab4_ipi/lab4_ipi.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wave_gen_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wave_gen_top.tcl -notrace
