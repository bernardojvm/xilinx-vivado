...
HD_PWD='C:/xup/fpga_flow/2016_2_zynq_labs/lab2emb_v1/lab2emb_v1.runs/systemv1_axi_gpio_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systemv1_axi_gpio_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systemv1_axi_gpio_1_0.tcl
