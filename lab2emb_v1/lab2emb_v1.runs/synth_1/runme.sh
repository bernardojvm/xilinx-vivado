...
HD_PWD='C:/xup/fpga_flow/2016_2_zynq_labs/lab2emb_v1/lab2emb_v1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systemv1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systemv1_wrapper.tcl
