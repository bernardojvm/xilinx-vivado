...
HD_PWD='C:/xup/fpga_flow/2016_2_zynq_labs/lab2emb_v1/lab2emb_v1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log systemv1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source systemv1_wrapper.tcl -notrace
