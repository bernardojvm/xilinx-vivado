...
set rc [catch {
  ...
  open_checkpoint C:/xup/fpga_flow/2016_2_zynq_labs/lab6/lab6.runs/impl_1/uart_top.dcp
  ...
  write_hwdef -force -file uart_top.hwdef
...
set rc [catch {
  ...
  catch {file copy -force debug_nets.ltx uart_top.ltx}
