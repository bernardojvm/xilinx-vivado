...
HD_PWD='C:/xup/fpga_flow/TFMV2/TFM_GE/TFM_GE.runs/system_pblaze_s_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pblaze_s_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pblaze_s_0_0.tcl
