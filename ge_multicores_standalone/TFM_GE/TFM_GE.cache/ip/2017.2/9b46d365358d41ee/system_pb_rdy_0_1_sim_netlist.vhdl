...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pb_rdy is
  port (
    ...
    rdy_signals : in STD_LOGIC_VECTOR ( 9 downto 0 );
    clk : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pb_rdy is
  ...
  signal rdy_lastpB_i_2_n_0 : STD_LOGIC;
  signal \^rdy_out\ : STD_LOGIC;
  signal rdy_out_i_1_n_0 : STD_LOGIC;
  signal rdy_out_i_2_n_0 : STD_LOGIC;
begin
  rdy_out <= \^rdy_out\;
...
rdy_lastpB_i_2: unisim.vcomponents.LUT6
    generic map(
...
rdy_out_i_2: unisim.vcomponents.LUT6
    generic map(
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pb_rdy
     port map (
      clk => clk,
      rdy_out => rdy_out,
      rdy_signals(9 downto 0) => rdy_signals(9 downto 0)
    );
end STRUCTURE;
