...
HD_PWD='C:/xup/fpga_flow/2016_2_zynq_labs/pB_rdy/pB_rdy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pb_rdy.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pb_rdy.tcl
