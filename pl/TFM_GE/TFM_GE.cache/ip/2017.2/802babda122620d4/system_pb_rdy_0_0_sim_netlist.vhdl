...
-- Date        : Sun Jan  7 04:31:42 2018
-- Host        : Berna running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ system_pb_rdy_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pb_rdy is
  port (
    ...
    rdy_signals : in STD_LOGIC_VECTOR ( 1 downto 0 );
    clk : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pb_rdy is
  ...
  attribute SOFT_HLUTNM of rdy_lastpB_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of rdy_out_i_1 : label is "soft_lutpair0";
begin
  rdy_out <= \^rdy_out\;
rdy_lastpB_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
rdy_out_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"88B8"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "system_pb_rdy_0_0,pb_rdy,{}";
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pb_rdy
     port map (
      clk => clk,
      rdy_out => rdy_out,
      rdy_signals(1 downto 0) => rdy_signals(1 downto 0)
    );
end STRUCTURE;
