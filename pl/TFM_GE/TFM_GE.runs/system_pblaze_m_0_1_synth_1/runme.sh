...
HD_PWD='C:/xup/fpga_flow/TFMV2/TFM_GE/TFM_GE.runs/system_pblaze_m_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pblaze_m_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pblaze_m_0_1.tcl
