...
========================================================================================*/
	...
	write_read_ddr(SrcArray[0],BUFFER_BYTESIZE, 0);
	cdma_transfer(DDR_BASE_ADDRESS,DDR_BASE_WRITE_ADDRESS4,BUFFER_BYTESIZE);
	write_read_ddr(SrcArray[1],BUFFER_BYTESIZE, 0);
	cdma_transfer(DDR_BASE_ADDRESS,DDR_BASE_WRITE_ADDRESS5,BUFFER_BYTESIZE);
	write_read_ddr(SrcArray[2],BUFFER_BYTESIZE, 0);
	cdma_transfer(DDR_BASE_ADDRESS,DDR_BASE_WRITE_ADDRESS6,BUFFER_BYTESIZE);
	write_read_ddr(SrcArray[3],BUFFER_BYTESIZE, 0);
	cdma_transfer(DDR_BASE_ADDRESS,DDR_BASE_WRITE_ADDRESS7,BUFFER_BYTESIZE);
	write_read_ddr(SrcArray[0],BUFFER_BYTESIZE, 0);
	cdma_transfer(DDR_BASE_ADDRESS,DDR_BASE_WRITE_ADDRESS8,BUFFER_BYTESIZE);
	write_read_ddr(SrcArray[1],BUFFER_BYTESIZE, 0);
	cdma_transfer(DDR_BASE_ADDRESS,DDR_BASE_WRITE_ADDRESS9,BUFFER_BYTESIZE);
...
do{
	...
	if(irq_in==1){
		...
		cdma_transfer(DDR_BASE_WRITE_ADDRESS4,DDR_BASE_ADDRESS,4);
		write_read_ddr(DestArray,4, 1);
		printf("Valor final memoria pbs4 %d: %.2f \r\n",count,((float)DestArray[0]/4096));
		cdma_transfer(DDR_BASE_WRITE_ADDRESS5,DDR_BASE_ADDRESS,4);
		write_read_ddr(DestArray,4, 1);
		printf("Valor final memoria pbs5 %d: %.2f \r\n",count,((float)DestArray[0]/4096));
		cdma_transfer(DDR_BASE_WRITE_ADDRESS6,DDR_BASE_ADDRESS,4);
		write_read_ddr(DestArray,4, 1);
		printf("Valor final memoria pbs6 %d: %.2f \r\n",count,((float)DestArray[0]/4096));
		cdma_transfer(DDR_BASE_WRITE_ADDRESS7,DDR_BASE_ADDRESS,4);
		write_read_ddr(DestArray,4, 1);
		printf("Valor final memoria pbs7 %d: %.2f \r\n",count,((float)DestArray[0]/4096));
		cdma_transfer(DDR_BASE_WRITE_ADDRESS8,DDR_BASE_ADDRESS,4);
		write_read_ddr(DestArray,4, 1);
		printf("Valor final memoria pbs8 %d: %.2f \r\n",count,((float)DestArray[0]/4096));
		cdma_transfer(DDR_BASE_WRITE_ADDRESS9,DDR_BASE_ADDRESS,4);
		write_read_ddr(DestArray,4, 1);
		printf("Valor final memoria pbs9 %d: %.2f \r\n",count,((float)DestArray[0]/4096));
