...
CONFIG.NUM_SI {1} \
  ...
  # Create instance: pBlaze_0, and set properties
  set pBlaze_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:pBlaze:1.0 pBlaze_0 ]

  # Create instance: pb_rdy_0, and set properties
  set pb_rdy_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:pb_rdy:1.0 pb_rdy_0 ]
  set_property -dict [ list \
CONFIG.CORES_WIDTH {1} \
 ] $pb_rdy_0
...
CONFIG.NUM_PORTS {2} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins pBlaze_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins pBlaze_0/instruction]
  connect_bd_net -net axi_cdma_0_cdma_introut [get_bd_pins axi_cdma_0/cdma_introut] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net pBlaze_0_address [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins pBlaze_0/address]
  connect_bd_net -net pBlaze_0_pB_rdy [get_bd_pins pBlaze_0/pB_rdy] [get_bd_pins pb_rdy_0/rdy_signals]
  connect_bd_net -net pBlaze_0_ram_enable [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins pBlaze_0/ram_enable]
  connect_bd_net -net pBlaze_0_rst [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins pBlaze_0/rst]
  connect_bd_net -net pb_rdy_0_rdy_out [get_bd_pins pb_rdy_0/rdy_out] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_cdma_0/m_axi_aclk] [get_bd_pins axi_cdma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins pBlaze_0/s_axi_aclk] [get_bd_pins pb_rdy_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_cdma_0/s_axi_lite_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins pBlaze_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pBlaze_0/S_AXI/S_AXI_reg] SEG_pBlaze_0_S_AXI_reg
