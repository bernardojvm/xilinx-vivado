...
HD_PWD='C:/xup/fpga_flow/2016_2_zynq_labs/sol_v1/sol_v1.runs/system_pBlaze_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pBlaze_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pBlaze_0_1.tcl
