...
/* Definitions for driver PBLAZE */
#define XPAR_PBLAZE_NUM_INSTANCES 1

/* Definitions for peripheral PBLAZE_0 */
#define XPAR_PBLAZE_0_DEVICE_ID 0
#define XPAR_PBLAZE_0_S_AXI_BASEADDR 0x43C00000
#define XPAR_PBLAZE_0_S_AXI_HIGHADDR 0x43C0FFFF
